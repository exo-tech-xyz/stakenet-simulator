...
impl ValidatorHistoryEntry {
    ...
    pub async fn fetch_all_validator_history_entries_manual(
        db_connection: &Pool<Postgres>,
        ...
        for row in rows {
            let entry = ValidatorHistoryEntry {
                ...
                validator_history_entry: JitoValidatorHistoryEntry {
                    ...
                    total_priority_fees: try_from_i64_to_u64(
                        row.get::<i64, _>("total_priority_fees"),
                    )?,
                    total_leader_slots: try_from_i32_to_u32(
                        row.get::<i32, _>("total_leader_slots"),
                    )?,
